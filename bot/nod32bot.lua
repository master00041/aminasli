...
function create_config( )
  ...
  config = {
    ...
    about_text = [[
an intelligent bot for managering telegram groups
sudos:@Oomaster_officialoO,@horizon_rz,@Ooo_amirreza_darkness_ooO
special thanks to 
@R_A_D_D_Y
]],
    help_text_realm = [[
